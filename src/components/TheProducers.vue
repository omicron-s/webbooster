...
const glob = import.meta.glob(['@/assets/img/producers/*.{jpg,png,webp}', '!@/assets/img/producers/bg*.{jpg,png,webp}'], {import: 'default',eager: true})
const sponsorList = Object.entries(glob).map(path => ({src: path[1], title: path[0].split('/').pop().split(".")[0]}));
